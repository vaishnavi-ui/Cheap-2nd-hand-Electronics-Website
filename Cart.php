            ...
            ?>
                    <div style="float: right;width: 35%;">
                        <div id="orderSummary">
                            ...
                            <button id="bhover"> <a href="Payment.php" style="text-decoration: none;color: black;font-size: 18px;font-family: 'Georgia';">Proceed to checkout</a></button>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function del(id,n)
        {
            ...
            var json_str = JSON.stringify(items);
             document.cookie = "cartItems = "+json_str;
